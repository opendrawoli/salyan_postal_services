  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ (@$right)? route('SALYANPOSTAL22200.right.update',$right->id) : route('SALYANPOSTAL22200.right.store')}}" method="POST" enctype="multipart/form-data">
			@csrf
      @if(@$right)
          @method('PUT')
      @else
        ...
        <div class="col-md-6">
          ...
          <div class="item form-group">
            <div class="col-md-6 col-sm-6 offset-md-5">
              <a href="{{route('SALYANPOSTAL22200.right.index')}}" class="btn btn-secondary btn-sm" type="button">Cancel</a>
