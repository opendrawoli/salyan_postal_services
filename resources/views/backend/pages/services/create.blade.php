  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data">
			@csrf
		...
		<div class="row">
			<div class="col-md-6">
	            ...
	            <input type="text" name="title_nepali" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Enter Your Title In Nepali">
	           	<label class="col-form-label " for="first-name">Description(नेपालीमा) <span class="required">*</span>
	            </label>
	            <textarea name="description_nepali"></textarea>		           
			</div>
			<div class="col-md-6">
				<label class="col-form-label " for="first-name">Title(English) <span class="required"></span>
		         </label>
		        <input type="text" name="title_english" class="form-control has-feedback-left" id="inputSuccess3" placeholder="Enter Your Title In English" >
		           
	           	<label class="col-form-label " for="first-name">Description(English) <span class="required">*</span>
	            </label>
	            <textarea name="description_english"></textarea>
